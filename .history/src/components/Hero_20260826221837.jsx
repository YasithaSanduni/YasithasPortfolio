        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            ...
            <div className="social-links">
              <a href="YOUR_LINKEDIN_URL" target="_blank" rel="noopener noreferrer" className="social-icon"><Linkedin size={20} /></a>
              <a href="YOUR_GITHUB_URL" target="_blank" rel="noopener noreferrer" className="social-icon"><Github size={20} /></a>
